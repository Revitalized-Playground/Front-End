...
class SearchableMap extends Component {
    ...
    handleGeocoderViewportChange = viewport => { // Receives new viewport coord from geocode forward search
        return this.handleViewportChange({
            ...viewport,
        });
    };

    handleOnResult = event => { // When this function receives a new object, it maps it and moves to it
        ...
        return (
            <div className="searchable-map">
                ...
                >
                    ...
                    { sampleGpsArray.map((gpsObject, i) =>  // Runs through hardcoded the array and drops a marker at each coord. Need to move this to data model
                        {
                            return (
                                <Marker 
                                    key={i} 
                    ...
                    ?   
                        <div className="searchable-map-popup">
                            <Popup
                                ...
                                closeButton={true}
                                closeOnClick={false}
                                onClose={() => this.setState({ ...this.state, showPopup: false, selectedProject: null })}
                                anchor="top-left"
                                offsetTop={30}
                                offsetLeft={15}
                            >
                                ...
                                <p>
                                    ...
                                    <br/>
                                    <i>
                                        {selectedProject.properties.category}
                                    </i> 
                                </p>
                            </Popup>
                        </div>
