            ...
            <div className='comment-inner-container'>
                ...
                <div className='dot-position-div'>
                        ...
                        <div className='lowerCommentSide'>
                            <form>
                                ...
                                <div className='edit-form-buttons'>
                                    <button onClick={(e) => {submitEditComment(e); setEditing(false)}}>Save</button> <button onClick={() => setEditing(false)}>Cancel</button>
                                </div>
                    ...
                    <div className='settings-drop' onClick={() => setSettings(!eachSetting)}>
                        <div className='dot-container'><div onClick={() => setSettings(!eachSetting)} className='dot'></div><div className='dot'></div><div className='dot'></div></div>
                    {comment.profile.id === currentUser().profileId && eachSetting 
                        ? 
                    <div className='settings-drop-buttons'><button onClick={() => setEditing(true)}>Edit</button><button onClick={(e) => deleteComment(e, comment.id)}>Delete</button></div>
                        :
                    null
                    }
                    </div>
